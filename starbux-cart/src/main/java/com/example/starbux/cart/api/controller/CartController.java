package com.example.starbux.cart.api.controller;

import com.example.starbux.cart.api.commands.AddItemCommand;
import com.example.starbux.cart.api.commands.ConfirmCartCommand;
import com.example.starbux.cart.api.commands.OpenCartCommand;
import com.example.starbux.cart.api.commands.RemoveItemCommand;
import com.example.starbux.cart.api.dto.OpenCartResponse;
...
public class CartController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> openCart(@RequestBody OpenCartCommand command) {
        ...
        try {
            ...
            var safeErrMessage = MessageFormat.format("Error while processing request to open new cart for id = {0} ", id);
